...
import ArticleMobileList from './mobile/article-mobile-list'
...
class MobileVersion extends React.Component{
	...
	componentWillUnmount() {
  		window.removeEventListener('popstate', this.handleBackWindow, false)
	}

	componentDidMount() {
		window.onhashchange = this.handleBackWindow
